...
public class MidnightColourPalette implements ColourPalette {
    @Override public String getName() { return "Midnight"; }
    @Override public String getDescription() { return "Deep blue and purple theme."; }

    @Override public String reset() { return "\u001B[0m"; }
    @Override public String bold() { return "\u001B[1m"; }

    @Override public String primary() { return "\u001B[34m"; } // Blue
    @Override public String secondary() { return "\u001B[35m"; } // Magenta
    @Override public String accent() { return "\u001B[94m"; } // Bright Blue
    ...
    @Override public String divider() { return "\u001B[34m"; } // Blue
    @Override public String softDivider() { return "\u001B[90m"; } // Gray
}
